...
from couchbase_v3 import JSONDocument, Durability
...
class Scenarios(ConnectionTestCase):
    ...
    def setUp(self):
        ...
        # 2) Open a Collection
        self.coll = self.scope.default_collection() if PYCBC_BYPASS_V3_FAILURES else self.scope.open_collection("people")
    ...
    def retry_idempotent_remove_client_side(callback,  # type: Callable[[ReplicateTo.Value],Any]
        ...
        while not success:
            ...
            try:
                ...
                success = True
            except couchbase_v3.exceptions.KeyNotFoundException:
    ...
    def retry_idempotent_remove_server_side(self,
        ...
        while FiniteDuration.time() < deadline:
            ...
            except couchbase_v3.exceptions.DurabilitySyncWriteAmbiguousException:
