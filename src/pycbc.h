...
int pycbc_collection_init_from_fn_args(pycbc_Collection_t *self, PyObject *kwargs);
pycbc_Collection_t pycbc_Collection_as_value(pycbc_Bucket *self,
                                             PyObject *kwargs);

pycbc_Collection_t* pycbc_Collection_ptr(pycbc_Bucket* self, pycbc_Collection_t* in_place, PyObject* kwargs);
#define PYCBC_COLLECTION_INIT(SELF,KWARGS) \
    pycbc_Collection_t cb_collection= {0};\
    pycbc_Collection_t* pcb_collection=pycbc_Collection_ptr(self, &cb_collection, KWARGS);
