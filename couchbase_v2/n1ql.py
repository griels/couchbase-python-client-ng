...
from couchbase_v2.deprecation import deprecate_module_attribute
...
"""
.. deprecated:: 2.3.3
   Use :attr:`couchbase_v2.n1ql.NOT_BOUNDED` instead. This had no effect in its advertised
...
"""
.. deprecated:: 2.3.3
   Use :attr:`couchbase_v2.n1ql.CONSISTENCY_UNBOUNDED` instead. This had no effect in its advertised
...
class N1QLQuery(object):
    ...
    def consistent_with(self, state):
        ...
        :param state: The state of the mutations it should be consistent
            with.
        :type state: :class:`~.couchbase_v2.mutation_state.MutationState`
        """
    ...
    def timeout(self):
        ...
        .. note::
            ...
            or the value of :attr:`couchbase_v2.bucket.Bucket.n1ql_timeout`
            property, whichever is *lower*.

        .. seealso:: couchbase_v2.bucket.Bucket.n1ql_timeout
        """
