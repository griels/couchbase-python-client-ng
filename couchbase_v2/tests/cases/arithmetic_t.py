...
from couchbase_v2.exceptions import (NotFoundException, DeltaBadvalException)
...
class ArithmeticTest(ConnectionTestCase):
    ...
    def test_incr_notfound(self):
        ...
        self.cb.remove(key, quiet=True)
        self.assertRaises(NotFoundException, self.cb.counter, key)
    ...
    def test_incr_multi(self):
        ...
        self.assertRaises(NotFoundException, self.cb.counter_multi, keys)
