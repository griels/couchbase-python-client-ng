...
class IndexManagementTestCase(RealServerTestCase):
    ...
    def test_create_primary(self):
        ...
        self.assertRaises(E.NotFoundException, mgr.n1ql_index_drop_primary)
        ...
        self.assertRaises(E.NotFoundException, mgr.n1ql_index_drop, ixname)
    ...
    def test_deferred(self):
        ...
        self.assertRaises(E.NotFoundException, mgr.n1ql_index_watch, ['nonexist'])
