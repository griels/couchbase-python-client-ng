...
class GetTest(ConnectionTestCase):
    ...
    def test_get_missing_key(self):
        ...
        self.assertRaises(NotFoundException, self.cb.get, 'key_missing_1',
                          quiet=False)
    ...
    def test_multi_mixed(self):
        ...
        for k, v in kv_missing.items():
            ...
            self.assertTrue(NotFoundException._can_derive(rvs[k].rc))
    ...
    def test_get_ttl(self):
        ...
        self.assertFalse(rv.success)
        self.assertTrue(NotFoundException._can_derive(rv.rc))
    ...
    def test_get_multi_ttl(self):
        ...
        for k, v in rvs.items():
            ...
            self.assertTrue(NotFoundException._can_derive(v.rc))
