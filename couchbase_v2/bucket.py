...
import couchbase_v2
from couchbase_v2.exceptions_backport import *
...
from couchbase_v2.views.params import make_dvpath, make_options_string
from couchbase_v2.views.iterator import View
from couchbase_v2.n1ql import N1QLQuery, N1QLRequest
import couchbase_v2.fulltext as _FTS
...
class Bucket(_Base):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :return: instance of :class:`~couchbase_v2.bucket.Bucket`
    ...
    def mutate_in(self, key, *specs, **kwargs):
        ...
        :param specs: A list of specs (See :mod:`.couchbase_v2.subdocument`)
        ...
        :return: A :class:`~.couchbase_v2.result.SubdocResult` object.
        ...
        .. seealso:: :mod:`.couchbase_v2.subdocument`
        """
    ...
    def lookup_in(self, key, *specs, **kwargs):
        ...
        :param spec: A list of specs (see :mod:`.couchbase_v2.subdocument`)
        :return: A :class:`.couchbase_v2.result.SubdocResult` object.
    ...
    def _view(self, ddoc, view,
        ...
        :return: a :class:`~couchbase_v2.result.HttpResult` object.
        """
    ...
    def n1ql_timeout(self):
        ...
        :attr:`couchbase_v2.n1ql.N1QLQuery.timeout` property. The effective
    ...
    def _wrap_dsop(self, sdres, has_value=False):
        from couchbase_v2.items import Item
        it = Item(sdres.key)
        it.cas = sdres.cas
        if has_value:
            it.value = sdres[0]
