...
class ResourcedTestCase(ResourcedTestCaseReal):
    ...
    def deepDiffComparator(self, expected, actual):
        self.assertEqual({},DeepDiff(expected,actual,ignore_order=True, significant_digits=5,ignore_numeric_type_changes=True,ignore_type_subclasses=True, ignore_string_type_changes=True))

    def assertSanitizedEqual(self, actual, expected, ignored={}, comparator=None):
        ...
        comparator(self, expected_json_sanitized, actual_json_sanitized)
