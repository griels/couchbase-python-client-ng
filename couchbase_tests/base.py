...
class ClusterTestCase(CouchbaseTestCase):
    ...
    def _instantiate_cluster(self, connstr_nobucket, cluster_factory=None, **kwargs):
        cluster_factory = cluster_factory or self.cluster_factory
