...
class Cluster(object):
    ...
    def __init__(self,
        ...
        bucket_factory = cluster_opts.pop('bucket_factory', bucket_factory)  # type: Bucket
        ...
        self._cluster = CoreCluster(connection_string,bucket_factory=corecluster_bucket_factory)#, **cluster_opts)  # type: CoreCluster
