...
from couchbase.options import OptionBlockTimeOutVerbatim as OptionBlock, timeout_forward_args as forward_args, Duration
from typing import *
...
class QueryIndexManager(GenericManager):
    ...
    def _drop_index(self, bucket_name, index_name, *options, primary=False, **kwargs):
        info = BucketManager._mk_index_def(bucket_name, index_name, primary=primary)
