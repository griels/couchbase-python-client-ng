...
from couchbase_core.mapper import BijectiveMapping, \
    StringEnum, Identity, Timedelta, str_enum, Bijection, str_enum_loose
...
class BucketSettings(dict):
    mapping = BijectiveMapping({'flushEnabled': {'flush_enabled': Bijection(int.__bool__,bool.__int__)},
                                ...
                                'bucketType': {'bucket_type': -str_enum_loose(BucketType)},
                                'maxTTL': {'max_ttl': -Timedelta()},
                                'compressionMode': {'compression_mode': -str_enum_loose(CompressionMode)},
                                'conflictResolutionType': {'conflict_resolution_type': Identity(str)},
                                'evictionPolicy': {'eviction_policy': -str_enum(EvictionPolicyType)},
