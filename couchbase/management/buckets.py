...
#def mapping_wrapper(name, bij_type, fn):
#    from functools import wraps
#    @property()
#    def bijection(src_data):


class BucketSettings(dict):
    mapping = BijectiveMapping({'flushEnabled': {'flush_enabled': Identity[bool]},
