...
class Scenarios(ConnectionTestCase):
    ...
    def setUp(self):
        ...
        self.defcoll=self.bucket.default_collection()
    ...
    def test_scenario_c_server_side_durability(self):
        ...
        except couchbase_core.exceptions.NotSupportedOnV2Error as e:
    ...
    def test_increment(self):
        try:
            ...
            self.defcoll.remove("counter",quiet=True)
        except:
            pass
    ...
    def test_cluster_query(self):
        if self.is_mock:  # TODO: fix for real server
