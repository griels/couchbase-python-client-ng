...
class CouchbaseError(Exception):
    ...
    **Exception Attributes**
      ...
      The return code which caused the error
        ...
        A :class:`~couchbase_v2.result.MultiResult` object, if this
...
class TemporaryFailError(CouchbaseError):
    ...
    .. seealso::
        ...
        :meth:`couchbase_v2.bucket.Bucket.lock`
        :meth:`couchbase_v2.bucket.Bucket.unlock`
    """
...
class NotSupportedError(CouchbaseError):
    ...
    differs from :exc:`couchbase_v2.exceptions.UnknownCommandError` by
