...
from couchbase_core import priv_constants as _P, fulltext as _FTS, subdocument as SD, exceptions, _depr
...
class Client(_Base):
    ...
    def retrieve_in(self, key, *paths, **kwargs):
        ...
        """
        import couchbase_core.subdocument as SD
        return Client.lookup_in(self, key, tuple(SD.get(x) for x in paths), **kwargs)
