...
class Admin(LCB.Bucket):
    ...
    :class:`~couchbase_v2.bucket.Bucket` is used for that.
    """
    def __init__(self, username, password, host='localhost', port=8091,
        ...
        :raise:
            :exc:`couchbase_v2.exceptions.AuthError` if incorrect credentials
            were supplied

            :exc:`couchbase_v2.exceptions.ConnectError` if there was a problem
    ...
    def bucket_create(self, name, bucket_type='couchbase',
        ...
        :param string bucket_type: The type of bucket to create. This
            can either be `couchbase` to create a couchbase_v2 style
    ...
    def user_get(self, domain, userid):
        ...
        :raise: :exc:`couchbase_v2.exceptions.HTTPError` if the user does not exist.
    ...
    def user_upsert(self, domain, userid, password=None, roles=None, name=None):
        ...
        :raise: :exc:`couchbase_v2.exceptions.HTTPError` if the request fails.
