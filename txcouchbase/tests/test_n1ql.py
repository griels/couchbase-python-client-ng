...
class TxN1QLTests(Base):
    ...
    def gen_cluster(self,  # type: MockTestCase
        ...
        base_cluster= TxCluster(connection_string=str(connstr_nobucket), authenticator=ClassicAuthenticator(self.cluster_info.admin_username, self.cluster_info.admin_password), **kwargs)
