...
from couchbase.cluster import PasswordAuthenticator, ClassicAuthenticator, PasswordAuthenticator
...
from couchbase.cluster import ClassicAuthenticator, Cluster
