...
class BatchedRowMixin(object):
    def __init__(self, *args, **kwargs):
        ...
        :class:`~couchbase_v2.views.iterator.Views` for more details.
...
class RawBucket(AsyncBucket):
    ...
    def defer(self, opres):
        """
        Converts a raw :class:`couchbase_v2.results.AsyncResult` object
        ...
        :type opres: :class:`couchbase_v2.results.AsyncResult`
