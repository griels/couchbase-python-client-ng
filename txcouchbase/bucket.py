...
from couchbase.collection import AsyncCBCollection
...
RawBucket = RawClientFactory.gen_raw(AsyncBucket)
RawCollection = RawClientFactory.gen_raw(AsyncCBCollection)
...
Bucket = ClientFactory.gen_client(RawBucket)
Collection = ClientFactory.gen_client(RawCollection)